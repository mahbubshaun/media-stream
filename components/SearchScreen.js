...
const SearchScreen = ({ navigation, toggleBottomTab }) => {

	// useEffect(() => {
	// 	// Hide the bottom tab bar when the component mounts
	// 	toggleBottomTab(true);
	
	// 	// // Optionally, you can show the bottom tab bar when the component unmounts
	// 	// return () => {
	// 	//   toggleBottomTab(true);
	// 	// };
	//   }, []);
