...
class Movies extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .all([
        axios.get(
          `${config.API_URL}/trending/movie/day?language=en-US&page=1`,
          { headers }
        ),
        axios.get(`${config.API_URL}/movie/popular?language=en-US&page=1`, {
          headers,
        }),
        axios.get(`${config.API_URL}/movie/top_rated?language=en-US&page=1`, {
          headers,
        }),
      ])
      .then(
